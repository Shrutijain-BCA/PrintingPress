...
export default function Upload() {
  ...
  const isUploading = files.some((f: any) => f.uploading)
            ...
            <div className="bg-[#FF6B00] rounded-2xl px-5 py-4 flex items-center justify-between">
              <div>
                <p className="text-white font-black">
                  {isUploading ? 'Uploading…' : `${files.length} file${files.length > 1 ? 's' : ''} ready`}
                </p>
              ...
              <Button
                ...
                className="border-white text-[#FF6B00] bg-white hover:bg-orange-50"
              >
